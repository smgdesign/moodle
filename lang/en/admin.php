...
$string['disableadvanced'] = 'Default configuration';
$string['disableadvanceddefault'] = 'Use default features and plugins';
$string['disableadvanceddisable'] = 'Disable advanced features and plugins';
$string['disableadvancedinfo'] = 'Welcome to Moodle, our favorite LMS, you finished the setup process. You can use the site administration block to enable and disable all of Moodle\'s features and plugins. By default, most of the features and plugins are enabled, if you want to initially enable just the basic ones, use the menu below.';
