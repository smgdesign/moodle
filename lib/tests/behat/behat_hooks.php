...
class behat_hooks extends behat_base {
    ...
    protected function get_faildump_filename(StepEvent $event, $filetype) {
        ...
        $filename = $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText() . $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText() . $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText() . $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText() . $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText() . $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText() . $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText() . $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText() . $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText() . $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText() . $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText() . $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText() . $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText() . $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText() . $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText() . $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText() . $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText() . $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText() . $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText() . $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText() . $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText() . $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText() . $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText() . $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText() . $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText() . $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText() . $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText() . $event->getStep()->getParent()->getTitle() . '_' . $event->getStep()->getText();
